...
const JeffChat = () => {
    ...
    const chatWithJeff = async (event) => {
        try {
        ...
        body: JSON.stringify({
            userChat: "Pretend to be Jeff bezos and answer my questions. I will ask you some questions and you have to answer as if you are Jeff bezos. Dont take any other role. Dont reply anything like you understood. just reply as Jeff bezos. Make it look completely as you are a real Jeff bezos. Conversations starts." + storeUserInput,
                }),
            });
            ...
            <div className="flex flex-row w-screen h-screen">
                ...
                <section className={`mainAvatarGPTChatBox h-full flex-1 flex flex-col gap-y-3 items-center p-2 relative`}>
                    ...
                    <div className="flex flex-col gap-y-4 bg-black/40 w-1/3 items-center py-4">
                        <img src="/Images/jefff.png" className="w-40 h-40" alt="elon"></img>
                        <h1 className="text-blue-900 font-bold text-4xl" id="tagLine">Jeff</h1>
                ...
                justify-center items-center p-2 text-white rounded-t-md border-b border-white/10">
                        <img src="/Images/jefff.png" className="w-8 h-8" alt="user"></img>

                        {/* <h1>Hi, I am Elon. Lets have some chat. Ask me anything you want.</h1> */}
                        <h1>Heyy, I am Jeff. Lts have some fun chat..</h1>
                    ...
                    <div className="flex flex-col w-full hidden h-full" id="elon_interaction">
                        ...
                        <div className="flex flex-row gap-x-4 bg-gray-600 w-full container mx-auto max-w-screen-lg p-2 text-white rounded-b-md overflow-scroll h-1/3" >
                            <img src="/Images/jefff.png" className="w-8 h-8" alt="elon"></img>
                    ...
                    <form className="inputBox flex container max-w-4xl px-4 py-1 gap-x-3 absolute bottom-20 shadow-xl focus:outline-none items-center rounded-md" onSubmit={chatWithJeff}>
                        ...
                        <span className="hover:cursor-pointer text-xl hover:bg-black/40 px-3 rounded-md" onClick={chatWithJeff}>↗️</span>
