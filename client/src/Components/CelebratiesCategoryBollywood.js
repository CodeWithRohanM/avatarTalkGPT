...
import { CelebratiesBollywood } from "./ListItems";
...
const CelebratiesCategoryBollywood = () => {


    const pCategory = useSelector((state) => state.userReducer.categoryName);

    const [loader, setLoader] = useState(false);
    const [peopleArray, setPeopleArray] = useState(CelebratiesBollywood);
...
export default CelebratiesCategoryBollywood;