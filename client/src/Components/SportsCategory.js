...
import { Sports } from "./ListItems";

const SportsCategory = () => {

    const [loader, setLoader] = useState(false);
    const [peopleArray, setPeopleArray] = useState(Sports);
    ...
    return <>
        ...
        <div className="flex flex-row w-screen h-screen">
            ...
            <section className={`mainAvatarGPTChatBox h-full flex-1 flex flex-col gap-y-10 items-center p-2 relative bg-gradient-to-b from-cyan-100 to-cyan-50`}>
                ...
                <h1 className="text-blue-900 font-bold text-4xl bg-black/10 shadow-2xl bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-blue-600 to-blue-700 w-3/4 
